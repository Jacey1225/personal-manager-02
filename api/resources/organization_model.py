...
class OrganizationModel:
    ...
    async def create_organization(request: CreateOrgRequest, user_id: str):
        handler = await HandleOrganizations.fetch(user_id)
    ...
    async def delete_organization(request: OrgRequest):
        handler = await HandleOrganizations.fetch(request.user_id)
    ...
    async def add_project(request: OrgRequest, project_dict: dict):
        ...
        return await handler.add_project(request.organization_id, project_details)
    @staticmethod
