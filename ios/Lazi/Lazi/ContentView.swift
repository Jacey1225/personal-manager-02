...
struct ContentView: View {
    ...
    guard let url = URL(string: "http://192.168.1.188:8000/auth/login?username=\(username)&password=\(password)") else {
    ...
    guard let url = URL(string: "http://192.168.1.188:8000/auth/signup?username=\(username)&email=\(email)&password=\(password)") else {
            errorMessage = "Invalid URL"
            isLoading = false
            return
        }
    ...
    guard let url = URL(string: "http://192.168.1.188:8000/auth/google?user_id=\(userId)") else {
            errorMessage = "Invalid URL"
            isLoading = false
            return
        }
    ...
    guard let url = URL(string: "http://192.168.1.188:8000/auth/google/complete") else {
            errorMessage = "Invalid URL"
            isLoading = false
            return
        }
